...
export function Sidebar({ role }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed lg:static inset-y-0 left-0 z-40 w-64 border-r transform transition-transform duration-300 ease-in-out flex flex-col h-screen ",
      ...
      >
        ...
        <div className="p-4   mt-auto">
          <Button
            variant="ghost"
            className="w-full justify-start bg-red-400 text-gray-600 hover:text-red-600 hover:bg-red-50 cursor-pointer"
